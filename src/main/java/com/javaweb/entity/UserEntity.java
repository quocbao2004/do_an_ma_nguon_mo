...
//    private String address;
    ...
    @ManyToMany(mappedBy = "userEntities", fetch = FetchType.LAZY)
    private List<BuildingEntity> customerid = new ArrayList<>();
...
//    public List<AssignmentEntity> getAssignmentBuildingEntities() {
...
//    }
    ...
    public void setCustomer(List<BuildingEntity> customerId) {
        this.customerid = customerId;
    }
}
